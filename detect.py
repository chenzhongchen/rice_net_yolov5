...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='rice_data/images/val/IMG_20211011_113133_2.jpg', help='source')  # file/folder, 0 for webcam
